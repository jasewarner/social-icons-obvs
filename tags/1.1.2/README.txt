...
The plugin currently serves the following channels: Behance, Bitbucket, Dribbble, Facebook, GitHub, Google+, Instagram, LinkedIn, Pinterest, Soundcloud, Tumblr, Twitter, Vimeo, YouTube and YunoJuno.
...
1. Upload the `social-icons-obvs` package to the `/wp-content/plugins/` directory
1. Activate the plugin through the 'Plugins' menu in WordPress
1. Head over to the plugin settings page to activate your accounts, customise the look of your icons and display them on your website.
...
1. This is a screen shot of the *Accounts* section in the plugin settings page.
2. This is a screen shot of the *Customise* section.
